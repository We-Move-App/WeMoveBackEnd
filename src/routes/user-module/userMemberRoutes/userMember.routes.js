...
userMemberRoutes
  .route("/add-member")
  .post(isUserAuthenticated, addMemberUnderUser);
userMemberRoutes
  .route("/update-member/:memberId")
  .put(isUserAuthenticated, updateMemberUnderUser);
userMemberRoutes.route("/login-member").post(loginUser);
userMemberRoutes
  .route("/get-members")
  .get(isUserAuthenticated, getAllMembersUnderUser);
userMemberRoutes
  .route("/delete-member/:userId")
  .delete(isUserAuthenticated, deleteMemberByUserId);
...
userMemberRoutes.route("/viewTransaction").get(getTransactions);
